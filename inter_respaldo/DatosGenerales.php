...
<html lang="en">
    ...
    <body>
        ...
        <div id="contenedor2" class="container">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 xl12 blue-grey darken-3">
                        ...
                        <div class="col s12 m12 l12 xl12 z-depth-1">
                            ...
                            <div class="row">
                                <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                                    <a name="at3" id="at3" class="btn  red darken-4" onclick="atras('3');">ATRAS</a>
                                </div>
...
profesionalizar el acceso a nuevos mercados estratégicos.
                        ...
                        <div class="row">
                            <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                                <a name="at4" id="at4" class="btn  red darken-4" onclick="atras('4');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
            ...
            <form method="post" name="form5" id="form5">
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                        ...
                        <div class="row">
                            <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                                <a name="at5" id="at5" class="btn  red darken-4" onclick="atras('5');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                            <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                            <a name="at6" id="at6" class="btn  red darken-4" onclick="atras('6');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at7" id="at7" class="btn  red darken-4" onclick="atras('7');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at8" id="at8" class="btn  red darken-4" onclick="atras('8');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
            ...
            <form method="post" name="form9" id="form9">
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at9" id="at9" class="btn  red darken-4" onclick="atras('9');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
            ...
            <form method="post" name="form10" id="form10">
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at10" id="at10" class="btn  red darken-4" onclick="atras('10');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                        ...
                        <div class="row">
                            ...
                            <p>En caso de tener experiencia exportando, ¿A qué lugar ha exportado su producto y/o servicio?</p>
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at11" id="at11" class="btn  red darken-4" onclick="atras('11');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
                ...
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                        ...
                        <div class="row">
                            ...
                            <p>¿De su capacidad actual, que % podría destinar a exportación?</p>
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at12" id="at12" class="btn  red darken-4" onclick="atras('12');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
            ...
            <form method="post" name="form13" id="form13">
                <div class="row">
                    <div class="col s12 m12 l12 xl12 z-depth-1">
                        ...
                        <div class="row">
                        <div class="input-field col s4 m4 l3 xl3 offset-s1 offset-m1  offset-l1 offset-xl1">
                        <a name="at13" id="at13" class="btn  red darken-4" onclick="atras('13');">ATRAS</a>
                            </div>
                            <div class="input-field col s4 m4 l3 xl3 offset-s2 offset-m2 offset-l1 offset-xl5">
                            <input type="submit"  value="FINALIZAR" name="13" id="13" class="btn  red darken-4" onClick="return guardacont13('<? echo $id;?>');">
                            </div>
                        </div>
