    ...
    else
    {
            ...
            $.ajax({
                ...
                success:  function (response) {
                    //alert(response);
                    //val = response;
                    alert('Encuesta finalizada gracias por tu tiempo');
                    location.href='http://www.bluewolf.com.mx/testinter/';
                }
            });
...
function guardacont14(id) 
{
    ...
    else
    {
            ...
            $.ajax({
                data:  fd,
                url:   'GuardarDatosGenerales.php?var=13&f=1',
                type:  'post',
                cache: false,
                contentType: false,
                processData: false,
                ...
                success:  function (response) {
                    //alert(response);
                    val = response;
                    alert('Gracias por su tiempo en este momento completara el PASO 2 (Ficha Técnica)');
                    location.href='http://www.bluewolf.com.mx/testinter/DatosGenerales2.php?id=2&f='+response;
                }
            });
